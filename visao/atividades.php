  ...
  <head>
    ...
    <body>
	    ...
	    <!--MODAL DE EXCLUIR PERFIL-->
            ...
            <?php include_once("includs/modalAcertoErroPulo.php"); unset($_SESSION['mostrarModalRegistro']); unset($_SESSION['mostrarModalRegistroFinal']); ?>            
      ...
      <section id="conteudo" class="container">
        ...
        <div class="row">
          		...
          		<div class="panel-heading" style="background-color: #4cae4c; color:white; text-align:center;">
	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col">
	                    <select required id="buscarPor" title="Selecione pelo que gostaria de buscar" name="buscarPor" class="form-control">
	                      ...
	                      <option value="" <?php if (($_POST['buscarPor']==null)&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Buscar por</option>

                              <option value="atividade.titulo" <?php if (($_POST['buscarPor']=='atividade.titulo')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Título</option>

	                      <option value="atividade.dataCadastramento" <?php if (($_POST['buscarPor']=='atividade.dataCadastramento')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Data cadastramento</option>
	                ...
	                <div class="form-group">
	                  <div class="col">
	                    ...
	                    <input required type="text" class="form-control" <?php if (isset($_POST['parametro'])) { echo "value="."'".$_POST['parametro']."'"; } ?> placeholder="Busca" name="parametro" title="Digite aqui sua busca">
          		...
          		<div class="panel-body">
          			...
          			<div id="centro" class="col">
          				...
          				<div class="btn-group" role="group" arial-label="...">
										...
										<form name="atividades" action="questaoTipo1.php" method="post">
	          							...
	          							<button name="atividade" type="submit" value="<?php echo $codAtividade; ?>" style="margin: .5em; width: 160px; height: 100px;" title="<?php echo $titulo; ?>" class="btn btn-<?php if($pontuacaoTotalAluno>=$pontuacaoTotal){ echo 'success'; }else{ echo 'primary'; } ?>"><?php echo $tituloCortado; ?><br><?php echo $dataCadastramento; ?><br><?php echo $pontuacaoTotalAluno; ?>/<?php echo $pontuacaoTotal; ?><br>Pontos</button>
	                ...
	                <form name="paginacao" action="atividades.php" method="post">
	                    ...
	                    <div style="text-align: center">
	                      ...
	                      <input type="hidden" name="pagina" <?php if (isset($_POST['pagina'])) { echo "value='".$pagina."'"; } ?> >
	                      <input type="hidden" name="offset" <?php if (isset($_POST['offset'])) { echo "value='".$offset."'"; } ?> >

	                      <input type="hidden" name="buscarPor" <?php if (isset($_POST['buscarPor'])) { echo "value='".$_POST['buscarPor']."'"; } ?> >
	                      <input type="hidden" name="parametro" <?php if (isset($_POST['parametro'])) { echo "value='".$_POST['parametro']."'"; } ?> >
          ...
          <div id="informacoes" class="col-sm-4 col-sm-offset-0">
			...
			<div id="informacoes1" style="<?php if($_SESSION['nivel']==1){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>" >
			...
			<div id="informacoes2" style="<?php if($_SESSION['nivel']==2){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>" >
            ...
            <div id="informacoes3" style="<?php if($_SESSION['nivel']==3){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>" >
            ...
            <div id="informacoes4" style="<?php if($_SESSION['nivel']==4){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>" >
            ...
            <div id="informacoes5" style="<?php if($_SESSION['nivel']==5){ echo 'display: block;'; }else{ echo 'display: none;'; } ?>" >
