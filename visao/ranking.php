        ...
        <div class="col-sm">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-heading" style="background-color: #4cae4c; color:white;">
              ...
              <form class="form-inline" role="search" action="ranking.php" method="post">
                ...
                <div class="form-group">
                  <div class="col">
                    <a name="ranking" href="ranking.php" class="btn btn-default"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Ranking</a>
                  </div>
                </div>
