                ...
                <div class="form-group">
                  ...
                  <div class="col">
                    <select required id="buscarPor" title="Selecione pelo que gostaria de buscar" name="buscarPor" class="form-control">
                      ...
                      <option value="usuario.usuario" <?php if (($_POST['buscarPor']=='usuario.usuario')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Usuário</option>

                      <option value="usuario.email" <?php if (($_POST['buscarPor']=='usuario.email')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >E-mail</option>

                      <option value="grupo.grupo" <?php if (($_POST['buscarPor']=='grupo.grupo')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Grupo</option>

                      <option value="usuario.data" <?php if (($_POST['buscarPor']=='usuario.data')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Data cadastramento</option>
