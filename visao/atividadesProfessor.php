...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>AlgtTot: Atividades Professor</title>
       ...
       <div class="modal-dialog" role="document">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
             <button name="acao" id="acaoCadastro" type="submit" value="CadastrarAtividade" class="btn btn-success"><span class="glyphicon glyphicon-save"></span> Cadastrar</button>
           </div>
        ...
        <div class="row">
          ...
          <div id="niveis" class="col-sm-8">
                             ...
                             <div id="editarAtividade<?php echo $dado['cdAtividade'] ?>" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="gridSystemModalLabel">
                               ...
                               <div class="modal-dialog" role="document">
                                  ...
                                  <div class="modal-content">
                                     ...
                                     <div class="modal-header" style="background-color: #4cae4c; color: white;">
                                      <a  class="close"  href="atividadesProfessor.php" aria-label="Close"><span aria-hidden="true">&times;</span></a>
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <select required disabled name="nivel" id="nivel<?php echo $dado['cdAtividade'] ?>" class="form-control" title="Selecione um nivel para a atividade">
                                              ...
                                              <option <?php if ($dado['nivel']==1) { echo "selected"; } ?> value="1">1</option>
                                              <option <?php if ($dado['nivel']==2) { echo "selected"; } ?> value="2">2</option>
                                              <option <?php if ($dado['nivel']==3) { echo "selected"; } ?> value="3">3</option>
                                              <option <?php if ($dado['nivel']==4) { echo "selected"; } ?> value="4">4</option>
                                              <option <?php if ($dado['nivel']==5) { echo "selected"; } ?> value="5">5</option>
                                        ...
                                        <div class="input-group">
                                          ...
                                          <select required disabled name="status" id="status<?php echo $dado['cdAtividade'] ?>" class="form-control" title="Selecione o status da atividade">
                                              ...
                                              <option <?php if ($dado['status']=='ativo') { echo "selected"; } ?> value="ativo">Ativo</option>
                                              <option <?php if ($dado['status']=='inativo') { echo "selected"; } ?> value="inativo">Inativo</option>
                                          </select>
                                          <span class="input-group-btn">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <input name="pontuacaoTotal" type="text" class="form-control" disabled value="<?php if ($dado['pontuacaoTotal']==null){ echo 0; }else{ echo $dado['pontuacaoTotal']; } ?>" placeholder="Pontuação Total" title="Esta é a pontuação total que esta atividade possui no momento." aria-describedby="sizing-addon2">
                                        </div>
            ...
            <div class="panel-footer">
                ...
                <form name="paginacao" action="atividadesProfessor.php" method="post">
