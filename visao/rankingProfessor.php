...
<head>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
      ...
      <title>AlgtTot: Ranking Professor</title>
        ...
        <div class="col-sm">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-heading" style="background-color:#4cae4c;color:white;">
              ...
              <form class="form-inline" role="search" action="rankingProfessor.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col">
                    <select required id="buscarPor" title="Selecione pelo que gostaria de visualizar" name="buscarPor" class="form-control">
                      ...
                      <option value="" <?php if (($_POST['buscarPor']==null)&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Organizar por</option>

                      <option value="usuario.nivel1" <?php if (($_POST['buscarPor']=='usuario.nivel1')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Nível 1</option>

                      <option value="usuario.nivel2" <?php if (($_POST['buscarPor']=='usuario.nivel2')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Nível 2</option>

                      <option value="usuario.nivel3" <?php if (($_POST['buscarPor']=='usuario.nivel3')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Nível 3</option>

                      <option value="usuario.nivel4" <?php if (($_POST['buscarPor']=='usuario.nivel4')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Nível 4</option>

                      <option value="usuario.nivel5" <?php if (($_POST['buscarPor']=='usuario.nivel5')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Nível 5</option>

                      <option value="usuario.pontuacaoTotal" <?php if (($_POST['buscarPor']=='usuario.pontuacaoTotal')&&(isset($_POST['buscarPor']))) { echo "selected"; } ?> >Pontuação Total</option>
                ...
                <div class="form-group">
                  <div class="col">
                      <a name="rankingADM" href="rankingProfessor.php" class="btn btn-default"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Ranking</a>
                  </div>
                </div>

                <div class="form-group">
                  <div class="col">
                      <a name="voltarInicio" href="principalProfessor.php" class="btn btn-default"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Início</a>
                  </div>
                </div>
            ...
            <div class="panel-footer">
                ...
                <form name="paginacao" action="rankingProfessor.php" method="post">
