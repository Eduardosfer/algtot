...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>AlgtTot: Questões ADM</title>
          ...
          <div id="niveis" class="col-sm-8">
          	...
          	<div class="panel panel-default">
                ...
                <form class="form-inline" role="search" action="" method="post">
                  ...
                  <div class="form-group">
                    <div class="col">
                      <a name="atividadesADM" href="atividadesADM.php" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> Voltar</a>
                    </div>
                  </div>
