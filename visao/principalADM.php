...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>AlgtTot: Principal ADM</title>
            ...
            <div class="row">
                            ...
                            <div id="centro" class="col">
                                ...
                                <center>
                                    ...
                                    <div class="btn-group-vertical" role="group">
                                        ...
                                        <a title="Clique para gerenciar as atividades" class="btn btn-success" href="atividadesADM.php"><span class="glyphicon glyphicon-duplicate" aria-hidden="true"></span> Gerenciar Atividades</a>

                                        <br>

                                        <a href="usuariosADM.php" title="Clique para gerenciar os usuários" class="btn btn-success"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Gerenciar Usuários</a>
                ...
                <div id="ranking" class="col-sm-5 col-sm-offset-0">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading" style="text-align:center;background-color:#4cae4c;color:white">
                            <h3>Ranking</h3>
                        </div>
...
?>
                                     ...
                                     <?php if ($contador > 1) { ?>
                                        <li><div class="alert alert-success" role="alert"><a href="rankingADM.php" class="alert-link">Ver Todos</a></div></li>
                                     <?php } else { ?>
